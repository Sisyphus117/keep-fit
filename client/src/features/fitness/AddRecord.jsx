...
function AddRecord({ record, onRemove, onFormDataChanged }) {
  ...
  // const { formData, setFormData, clearForm } = useFormData({
  //   ...record,
  // });
    ...
    <div>
      ...
      >
        <div className="contents">
          ...
          <select required id="item" value={item} onChange={handleChange}>
